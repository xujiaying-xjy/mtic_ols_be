...
public class SerializableUtil {
    ...
    public static byte[] serializable(Object object) {
        ...
        try {
            ...
            throw new MticException("SerializableUtil工具类序列化出现IOException异常:" + e.getMessage(), ErrorInfo.SERVICE_ERROR.getCode());
        } finally {
            try {
                if (oos != null) {
                    oos.close();
                ...
                throw new MticException("SerializableUtil工具类反序列化出现IOException异常:" + e.getMessage(), ErrorInfo.SERVICE_ERROR.getCode());
            }
        }
    }
    ...
    public static Object unserializable(byte[] bytes) {
        ...
        try {
            ...
            throw new MticException("SerializableUtil工具类反序列化出现ClassNotFoundException异常:" + e.getMessage(), ErrorInfo.SERVICE_ERROR.getCode());
        } catch (IOException e) {
            logger.error("SerializableUtil工具类反序列化出现IOException异常:" + e.getMessage());
            throw new MticException("SerializableUtil工具类反序列化出现IOException异常:" + e.getMessage(), ErrorInfo.SERVICE_ERROR.getCode());
        } finally {
